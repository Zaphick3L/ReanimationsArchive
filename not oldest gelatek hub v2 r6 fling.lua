...
Character:FindFirstChild("Head").Velocity = Vector3.new(29.99,0,0) 
Character:FindFirstChild("Right Arm").Velocity = Vector3.new(29.99,0,0) 
Character:FindFirstChild("Right Leg").Velocity = Vector3.new(29.99,0,0) 
Character:FindFirstChild("Left Arm").Velocity = Vector3.new(29.99,0,0) 
Character:FindFirstChild("Left Leg").Velocity = Vector3.new(29.99,0,0) 
for i ,v in pairs(Character:GetChildren()) do
	if v:IsA("Accessory") then
		v.Handle.Velocity = Vector3.new(29.99,0,0) 
	end
end
